...
Differences between implementations:
 - All operations but setters are non desctructive, applied on a new Matrix3d instance.
...
class DecomposedMatrix {
  ...
  constructor(perspective, translate, quaternion, skew, scale) {
